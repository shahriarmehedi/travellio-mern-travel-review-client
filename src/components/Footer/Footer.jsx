                ...
                <div className="flex flex-col lg:flex-row justify-between items-center w-4/6 mx-auto pt-10">
                    ...
                    <div>
                        ...
                        <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
                            ...
                            <button className="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-rose-500 border-0 py-2 px-6 focus:outline-none hover:bg-rose-500 rounded">Subscribe</button>
                        </div>
                        <p className="text-gray-500 text-sm mt-2 md:text-left text-center">Weekly newsletter & so on
                        </p>
                    </div>
                </div>
                <p className="pt-20 pb-5"> <small className="text-gray-400">© Copyright Protected | <span className='text-rose-400'>Travellio</span> </small> </p>
            </div>
        </div>
    );
};
